...
import Helps from "./cohortQueue/Help";
import NeedHelps from "./cohortQueue/NeedHelp";
import BeingHelps from "./cohortQueue/BeingHelp";
import Chat from "../Chat/Chat";
import jwtToken from "../tools/assets/jwtToken";
import { DarkModeContext } from "../../App";
import Search from "./cohortQueue/CohortFilter";  
          ...
          <div className={classes.tabRoot}>
            ...
            >
              ...
              <TabPanel
                ...
                className={classes.TabPanelpaperr}
              >
                <CohortDetails classes={classes} class_id={id} Lest = {Lest} />
              </TabPanel>
            </SwipeableViews>
          </div>
        </UserContext.Provider>
