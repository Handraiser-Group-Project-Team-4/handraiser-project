...
export default function PopupModal({
  ...
  const submitUserData = e => {
    ...
    const URL =
      type === "approving"
        ...
        : type === "Change User Role"
        ? `/api/assigning/${data.id}`
        : type === "Toggle Cohort"
        ? `/api/toggleCohort/${data.row.class_id}?toggle_class_status=${data.toggle_class_status}`
        : type === "Delete Cohort"
        ? `/api/deleteClass/${id}`
        : type === "Kick Student"
  ...
  return (
    <Dialog
      open={open}
      onClose={
        type === "Kick Student" ? e => handleClose(data.class_id) : handleClose
      }
